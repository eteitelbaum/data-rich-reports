...
{{< video https://youtu.be/X9im3Fod5H8 title="Downloading Data from the World Bank" >}}
...
{{< video https://youtu.be/uX89NcpJfQc title='Reading Data From a Flat File' >}}
...
{{< video https://youtu.be/sweUA0L8G3Y title='Reshaping Data With `pivot_longer()`' >}}
...
{{< video https://youtu.be/lj_HeZazwIk title='Truncating Strings and Changing Variable Types' >}}
...
{{< video https://youtu.be/UA7cwEIECZg title='Clean Variable Names with Janitor' >}}
