...
{{< video https://youtu.be/iOugfcOnoks title="Downloading Data from the World Bank" >}}
...
{{< video https://youtu.be/i5galFqlj8c title='Reading Data From a Flat File' >}}
...
{{< video https://youtu.be/yhFUUblhTNA title='Reshaping Data With `pivot_longer()`' >}}
...
{{< video https://youtu.be/-JT8JSR1z5A title='Truncating Strings and Changing Variable Types' >}}
...
{{< video https://youtu.be/7bgoebbzfKQ title='Clean Variable Names with Janitor' >}}
