...
{{< video https://youtu.be/gssjyyl7vxI title='Getting Started with R and R Studio' >}}
...
{{< video https://youtu.be/c654j7aQjcg title='Your First Quarto Document' >}}
...
Next, you need to generate a personal access token [(PAT)](https://happygitwithr.com/https-pat.html) and set your credentials with the [gitcreds](https://gitcreds.r-lib.org/) package. This is pretty simple once you have your PAT. After loading `gitcreds`, you type `gitcreds_get()` to see whether you already have credentials setup. From there you type `gitcreds_set()` to enter your new credentials (your username and your password, which will be the PAT that you just generated). 
