...
Now take a little time to create a Quarto project in R Studio and make sure everything is working properly. But before you get started, create a new folder(directory) for this course on your computer somewhere. Once that is done, go to **File** and select **New Project**. Then select **Quarto Project** and name the project something like "test-project" in the "Directory name:" field. Next, select **Browse** and navigate to the folder that you created for this course. Select **Create Project**. 
