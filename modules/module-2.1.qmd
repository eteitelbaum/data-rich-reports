...
- Have a look at the `ggplot2` [documentation](https://ggplot2.tidyverse.org/)  
- Familiarize yourself with the `ggplot2` [cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/data-visualization.pdf)
- Generate a quarto document named "module-2.1.qmd" so that you can use to follow along with this exercise
