...
# world_map_df |>
#   select(geometry) # view contents of geometry column
``` 
...
{{< video https://www.youtube.com/embed/wo9vZccmqwc title = 'Using rnaturalearth to map other data'>}}
