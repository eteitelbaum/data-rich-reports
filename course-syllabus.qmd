---
title: "IAFF 6502/05: Creating Data Rich Reports with Quarto"
...
This course will use Quarto to create data rich reports. Students will develop coding, data visualization, and data presentation skills. By the end of the course they will know how to use Quarto to integrate text with code and publish their work in multiple formats.
...
-   Create a Quarto document and structure its contents it using YAML
-   Integrate your text with code
-   Create basic data visualizations in R
-   Integrate data visualizations into your Quarto document
-   Render your document in multiple formats including HTML, PDF, and Word
-   Pubplish your Quarto document to the web with Quarto Pub
...
1.  Coding assignment 1 (30%)
2.  Coding assigntment 2 (30%)
3.  Final project (40%)
...
Communication in our course is essential; clearing up questions earlier than later is a good practice, so please don't hesitate to reach out to me. In any mode of communication used in our course, all of us will follow [netiquette](#_heading=h.49x2ik5) found in our syllabus.

We will communicate primarily through [GW's Blackboard System](https://blackboard.gwu.edu) and the Discord server. Announcements and emails sent through Blackboard may automatically go to your GW email address (i.e., userid\@gwu.edu). Please check your GW email account on a daily basis or forward your GW email to another address that you check daily.
