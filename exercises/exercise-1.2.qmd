...
3. Sort countries in descending order based on the mean value of `gdp_pc` (instead of `polyarchy`). Which country ranks first based on this sorting? 

4. Now try sorting countries in ascending order based on the median value of `women_rep` (hint: delete "desc" from the `arrange()` call). Which countries rank "highest" in this sorting?
